 ...
 *     getValorInternacao(). Implementada apenas por Cao e Gato; Bovino
 *     não assina, pois é atendido na própria fazenda.
 *
 ...
 *     (reaproveitando super.imprimirFicha() e acrescentando a raça).
 *
...
public class TesteVetCampo {
    ...
    public static void main(String[] args) {
        ...
        // Linha usada só na gravação do vídeo para mostrar o erro de
        // compilação de instanciar a superclasse abstrata (depois apagada):
        // Animal generico = new Animal("000", "x", "x", 1, 1) { };
        //   -> "Animal is abstract; cannot be instantiated"

        // 1) Cadastro dos três animais. Mel chega sem idade conhecida,
        // por isso usa o construtor sobrecarregado sem o parâmetro idade.
        ...
        // 2) Um único vetor do tipo da superclasse, percorrido com for,
        // imprimindo a ficha de cada um (polimorfismo).
        ...
        // 3) Mesmo vetor, agora imprimindo o valor da consulta sem plano
        // e com plano de saúde (sobrecarga de calcularValorConsulta).
        ...
        // 4) Internações: Thor por 3 diárias, Mel por 4, depois mais
        // 2 diárias para o Thor (acumulando às internações anteriores).
        thor.internar(3);
        mel.internar(4);
        thor.internar(2);

        // Linha usada só na gravação do vídeo para mostrar que o Bovino não
        // pode entrar no vetor do tipo da interface (depois apagada):
        // Internavel semSentido = estrela;
        //   -> "incompatible types: Bovino cannot be converted to Internavel"

        // 5) Vetor do tipo da interface, apenas com os animais internáveis,
        // percorrido sem repetir código para cão e para gato.
        ...
        // Tentativa de pesagem inválida: o sistema deve recusar.
        thor.setPeso(-4);
    }
}
